@echo off
echo ============================================
echo   FileFinder - Ultra-Fast Build System
echo ============================================
echo.
...
g++ -O3 -march=native -std=c++20 -mwindows -municode ^
    ...
    src/main.cpp src/search_engine.cpp src/gui.cpp bin/resources.res ^
    -o bin/FileFinder.exe ^
...
echo.
echo [SUCCESS] Built: bin\FileFinder.exe
exit /b 0
